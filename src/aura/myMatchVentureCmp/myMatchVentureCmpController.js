...
component.set("v.showSaveCancelBtn",false);
    ...
    sortByRanking: function(component, event, helper) {
        ...
        sortAsc = (sortAsc === true) ? false : true;        
        component.set("v.sortAsc", sortAsc);
        component.set("v.sortField", "Ranking__c");
        helper.doInitHelper(component, event);
      //  component.set("v.sortField", "Venture__r.Name");
    },
    ChangeshowSaveCancelBtn:function(component,event,helper){
        console.log('=>'+component.get("v.showSaveCancelBtn"));
       var cmpEvent = component.getEvent("Preference");
        cmpEvent.setParams({
            "showSaveCancelBtn" : component.get("v.showSaveCancelBtn") });
        cmpEvent.fire();
        //
        var appEvent = $A.get("e.c:MyPreferenceApplicationEvnt");
        appEvent.setParams({
            "showSaveCancelBtn" : component.get("v.showSaveCancelBtn") });
        appEvent.fire();
   ...
   onSearch : function(component, event, helper) {   
    ...
    resetView : function(component, event, helper) {
         ...
         console.log(isUnsavedData + '==unsaved==')
        if(isUnsavedData){
    ...
    Save: function(component, event, helper){
         var existingRankingList = component.get("v.existingRankingList");
        alert("Without click on save and cancel");
